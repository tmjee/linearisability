package synchrobench.hashtables.sequential;
...
public class SequentialHashIntSet implements CompositionalIntSet {
    ...
    public SequentialHashIntSet() {
        this(synchrobench.contention.benchmark.Parameters.size);
    }
	 ...
	 */
	public void clear() {
	    tableSize = synchrobench.contention.benchmark.Parameters.size;
	    table = new Node[tableSize];
	}
