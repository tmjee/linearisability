...
public class SbLockBasedFriendlyTreeMap_BulkPutRemove_Test extends Abstract_Map_BulkPutRemove_Test {
    ...
    @TestUnit(name="SbLockedBasedFriendlyTreeMap_BulkPutRemove_Test")
