...
public class SbLogicalOrderingAVL_PutRunningCount_Test extends Abstract_Map_PutRunningCount_Test{
    ...
    @TestUnit(name="SbLogicalOrderingAVL_PutRunningCount_Test")
