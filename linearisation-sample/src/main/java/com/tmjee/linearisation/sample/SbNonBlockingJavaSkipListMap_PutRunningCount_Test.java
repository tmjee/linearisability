...
import synchrobench.skiplists.lockfree.NonBlockingJavaSkipListMap;
...
public class SbNonBlockingJavaSkipListMap_PutRunningCount_Test extends Abstract_Map_PutRunningCount_Test {

    @Invariant
    public static class State extends Abstract_Map_PutRunningCount_Test.AbstractState {
        final Map<Integer,Integer> m = new NonBlockingJavaSkipListMap<>();
        @Override protected Map<Integer, Integer> get() { return m; }
    }

    @TestUnit(name="SbNonBlockingJavaSkipListMap_PutRunningCount_Test")
