...
import synchrobench.hashtables.lockbased.LockBasedJavaHashMap;
...
public class SbLockBasedJavaHashMap_PutRunningCount_Test extends Abstract_Map_PutRunningCount_Test {
    @Invariant
    public static class State extends Abstract_Map_PutRunningCount_Test.AbstractState {
        final Map<Integer,Integer> m = new LockBasedJavaHashMap<>();
        @Override protected Map<Integer, Integer> get() { return m; }
    }

    @TestUnit(name="SbLockBasedJavaHashMap_PutRunningCount_Test")
