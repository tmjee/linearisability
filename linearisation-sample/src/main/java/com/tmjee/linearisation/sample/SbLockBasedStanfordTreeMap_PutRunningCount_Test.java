...
public class SbLockBasedStanfordTreeMap_PutRunningCount_Test extends Abstract_Map_PutRunningCount_Test {
    ...
    @TestUnit(name="SbLockBasedStanfordTreeMap_PutRunningCount_Test")
