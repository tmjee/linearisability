...
public class SbNonBlockingJavaSkipListMap_BulkPutRemove_Test extends Abstract_Map_BulkPutRemove_Test {
    @Invariant
    ...
    @TestUnit(name="SbNonBlockingJavaSkipListMap_BulkPutRemove_Test")
