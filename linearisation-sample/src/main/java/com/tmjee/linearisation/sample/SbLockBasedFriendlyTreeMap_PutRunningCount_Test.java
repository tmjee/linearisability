...
import synchrobench.trees.lockbased.LockBasedFriendlyTreeMap;
...
public class SbLockBasedFriendlyTreeMap_PutRunningCount_Test extends Abstract_Map_PutRunningCount_Test{
    ...
    @TestUnit(name="SbLockBasedFriendlyTreeMap_PutRunningCount_Test")
